                ...
                menu: [
                    {
                        text:'系统管理',
                        items: [
                            // 公告管理菜单，点击后跳转到 Announcement/index.html 页面
                            {id:'12',text:'公告管理',href:'Announcement/index.html'},
                            // 广告管理菜单，点击后跳转到 Advertisement/index.html 页面
                            {id:'3',text:'广告管理',href:'Advertisement/index.html'},
                            // 轮播管理菜单，点击后跳转到 Carousel/index.html 页面
                            {id:'4',text:'轮播管理',href:'Carousel/index.html'},
                            // 兼职管理菜单，点击后跳转到 PartTimeJob/index.html 页面
                            {id:'6',text:'兼职管理',href:'PartTimeJob/index.html'},
                            // 帖子管理菜单，点击后跳转到 Post/index.html 页面
                            {id:'6',text:'帖子管理',href:'Post/index.html'}
                        ]
                    }
                ]
            },
                ...
                menu: [
                    {
                        text:'业务管理',
                        items: [
                            // 查询业务菜单，点击后跳转到 Node/index.html 页面
