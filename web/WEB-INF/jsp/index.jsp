...
<body>
					...
					<c:forEach var="c" items="${cList}">
						<dl>
							...
							<%--<c:forEach items="${c.csList}" var="cs">
								<dd>
									<a
										href="${pageContext.request.contextPath}/findCategorySecond1.action?cid=${cs.cid}&page=1">
										${cs.cname}</a>
								</dd>
							</c:forEach>--%>
						</dl>
			...
			<div id="result" class="result table clearfix">
				...
				<ul>
					<c:forEach items="${hList}" var="p"> 
						<li><a
							href="${pageContext.request.contextPath}/product/findProductByPid.action?pid=${p.pid}"
							target="_blank">
							 <img
			...
			<div id="result" class="result table clearfix">
				...
				<ul>
					<c:forEach items="${nList}" var="n"> 
						<li><a
							href="${pageContext.request.contextPath}/product/findProductByPid.action?pid=${n.pid}"
							target="_blank">
							 <img
	...
	<div class="container footer">
		...
		<div class="span24">
			<div class="copyright">Copyright © 农产品销售 版权所有</div>
		</div>
	</div>
</body>
</html>