...
<table width="100%" border="0">
	  <tr>
		...
		<script type="text/javascript">
			...
			d.add('010102','0101','管理员管理','${pageContext.request.contextPath}/admin/admin_findAdmin.action','','mainFrame');
			d.add('0102','01','分类管理','','','mainFrame');
			d.add('010201','0102','一级分类管理','${pageContext.request.contextPath}/category/findAll.action','','mainFrame');
			d.add('010202','0102','二级分类管理','${pageContext.request.contextPath}/admin/adminCategorySecond_findAllByPage.action?page=1','','mainFrame');
			d.add('0104','01','商品管理','','','mainFrame');
			d.add('010401','0104','商品管理','${pageContext.request.contextPath}/product/findAll.action?page=1','','mainFrame');
			d.add('010402','0104','商品分页管理','${pageContext.request.contextPath}/product/findAllByPage.action?page=1','','mainFrame');
